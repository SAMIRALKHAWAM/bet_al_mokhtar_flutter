                          ...
                          showDialog(
                            ...
                            builder: (_) => AlertDialog(
                              ...
                              actions: [
                                ...
                                TextButton(
                                  onPressed: () {
                                    AppCubit.get(context).table_change_statu(table_id: table.id);
                                    Navigator.pop(context);
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => WaiterOrderInterface(
                                          table.id, table.tableNumber, table.invoice_id,
                                        ),
                                      ),
                                    );
                                  },
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Icon(Icons.table_bar, size: 40, color: Colors.blueGrey),
                              Text(
